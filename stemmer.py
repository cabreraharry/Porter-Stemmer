...
# ... (the PorterStemmer class implementation goes here, as you provided)
...
# ... (PorterStemmer class implementation and other code as before)
...
# Rest of your code, including CSV processing, remains the same.
...
try:
    with open(input_file_path, 'r', encoding='utf-8') as input_file, open(output_file_path, 'w', newline='', encoding='utf-8') as output_file:
        ...
        for row in csv_reader:
            ...
            stemmed_text = stem_text(original_text)  # Call the stem_text function
    ...
    print(f"Unable to decode the file: {input_file_path}. Please make sure it is encoded in UTF-8.")
    sys.exit(1)
